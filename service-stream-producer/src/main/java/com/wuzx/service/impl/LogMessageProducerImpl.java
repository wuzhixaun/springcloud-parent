...
import com.wuzx.service.LogProcessor;
...
public class LogMessageProducerImpl implements LogMessageProducer {
    ...
    public void sendMessage(String content) {
         ...
         */
        logProcessor.outputLog().send(MessageBuilder.withPayload(content).build());
    }
}
